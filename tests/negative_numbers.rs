...
fn test_read_negative_value() {
    ...
    // FIXME: Uncomment once device driver is fixed
    ...
    //
    // let counter_value = icmd.read_counter().unwrap();
    // let cnt_0 = counter_value.get_cnt0().expect("Counter 0 should always be set up");
    // let cnt_1 = counter_value.get_cnt1().expect("Counter 1 should be set up in this configuration");
    //
